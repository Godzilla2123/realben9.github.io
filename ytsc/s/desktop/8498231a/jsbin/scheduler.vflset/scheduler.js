...
r.prototype.G=function(){if(this.B)for(;this.B.length;)this.B.shift()()};var t=m.window,u,v,w=(null==t?void 0:null==(u=t.yt)?void 0:u.config_)||(null==t?void 0:null==(v=t.ytcfg)?void 0:v.data_)||{};q("yt.config_",w);function x(a,b){return a in w?w[a]:b}
...
function C(a){a=void 0===a?{}:a;r.call(this);this.g=[];this.g[8]=[];this.g[4]=[];this.g[3]=[];this.g[2]=[];this.g[1]=[];this.g[0]=[];this.j=0;this.N=a.timeout||1;this.i={};this.o=A;this.C=this.h=this.m=0;this.D=this.l=!1;this.u=[];this.H=p(this.R,this);this.M=p(this.T,this);this.J=p(this.O,this);this.K=p(this.P,this);this.L=p(this.S,this);this.A=this.F=!1;var b;if(b=!!window.requestIdleCallback&&!!window.cancelIdleCallback)b=z("disable_scheduler_requestIdleCallback"),b=!("string"===typeof b&&"false"===
b?0:b);this.I=b;(this.v=!!a.useRaf&&!!window.requestAnimationFrame)&&document.addEventListener("visibilitychange",this.H)}
C.prototype=aa(r.prototype);C.prototype.constructor=C;if(l)l(C,r);else for(var D in r)if("prototype"!=D)if(Object.defineProperties){var E=Object.getOwnPropertyDescriptor(r,D);E&&Object.defineProperty(C,D,E)}else C[D]=r[D];function F(a,b){var c=Date.now();G(b);b=Date.now()-c;a.l||(a.o-=b)}
...
function M(a,b){a.A&&4==a.m&&a.h||J(a);a.l=!0;b=Date.now()+(b||a.o);for(var c=a.g[4];c.length;){var d=c.shift(),e=a.i[d];delete a.i[d];e&&G(e)}c=a.F?0:1;c=a.j>c?a.j:c;if(!(Date.now()>=b)){do{a:{d=a;e=c;for(var B=3;B>=e;B--)for(var T=d.g[B];T.length;){var U=T.shift(),V=d.i[U];delete d.i[U];if(V){d=V;break a}}d=null}d&&G(d)}while(d&&Date.now()<b)}a.l=!1;O(a);a.o=A;L(a)&&a.start()}
...
f.G=function(){K(this);J(this);this.v&&document.removeEventListener("visibilitychange",this.H);r.prototype.G.call(this)};var P=n("yt.scheduler.instance.timerIdMap_")||{},Q=y("kevlar_tuner_scheduler_soft_state_timer_ms",800),R=0,S=0;function W(){var a=n("ytglobal.schedulerInstanceInstance_");if(!a||a.s)a=new C(x("scheduler")||{}),q("ytglobal.schedulerInstanceInstance_",a);return a}
