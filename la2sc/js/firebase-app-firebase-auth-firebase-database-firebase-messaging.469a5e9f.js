 ...
 * limitations under the License.
 */
function d(e){var t={},r={},n={},o={__esModule:!0,initializeApp:f,app:s,apps:null,SDK_VERSION:h,INTERNAL:{registerService:d,removeApp:a,factories:r,useAsService:b}};function a(e){var r=t[e];v(r,"delete"),delete t[e]}function s(e){if(e=e||u,!i.contains(t,e))throw c.create("no-app",{appName:e});return t[e]}function f(r,n){if(void 0===n&&(n={}),"object"!==typeof n||null===n){var a=n;n={name:a}}var s=n;void 0===s.name&&(s.name=u);var f=s.name;if("string"!==typeof f||!f)throw c.create("bad-app-name",{appName:String(f)});if(i.contains(t,f))throw c.create("duplicate-app",{appName:f});var l=new e(r,s,o);return t[f]=l,v(l,"create"),l}function l(){return Object.keys(t).map((function(e){return t[e]}))}function d(t,a,u,f,h){if(void 0===h&&(h=!1),r[t])return p.debug("There were multiple attempts to register service "+t+"."),o[t];function d(e){if(void 0===e&&(e=s()),"function"!==typeof e[t])throw c.create("invalid-app-argument",{appName:t});return e[t]()}return r[t]=a,f&&(n[t]=f,l().forEach((function(e){f("create",e)}))),void 0!==u&&i.deepExtend(d,u),o[t]=d,e.prototype[t]=function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._getService.bind(this,t);return n.apply(this,h?e:[])},d}function v(e,t){for(var o=0,i=Object.keys(r);o<i.length;o++){var a=i[o],s=b(e,a);if(null===s)return;n[s]&&n[s](t,e)}}function b(e,t){if("serverAuth"===t)return null;var r=t;return r}return(o["default"]=o,Object.defineProperty(o,"apps",{get:l}),s["App"]=e,o)}
/**
 * @license
 * Copyright 2019 Google Inc.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(e){for(var t=[],r=function(e,r){Array.isArray(r)?r.forEach((function(r){t.push(encodeURIComponent(e)+"="+encodeURIComponent(r))})):t.push(encodeURIComponent(e)+"="+encodeURIComponent(r))},n=0,o=Object.entries(e);n<o.length;n++){var i=o[n],a=i[0],s=i[1];r(a,s)}return t.length?"&"+t.join("&"):""}function B(e){var t={},r=e.replace(/^\?/,"").split("&");return r.forEach((function(e){if(e){var r=e.split("=");t[r[0]]=r[1]}})),t}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
