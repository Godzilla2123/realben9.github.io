AddLanguage('IT','italian',{
	...
	"your cookies are displayed using a monospace font": "la quantitÃ  di biscotti viene mostrata con un carattere monospazio",
	"Short numbers": "Numeri abbreviati",
	"Fast notes": "Notifiche rapide",
	"notifications disappear much faster": "le notifiche scompaiono piÃ¹ rapidamente",
	...
	"the game will be less resource-intensive when out of focus": "il gioco limita le risorse utilizzate quando Ã¨ in background",
	...
	"Sleep mode timeout": "ModalitÃ  riposo",
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode": "sui computer piÃ¹ lenti, il gioco entra automaticamente in modalitÃ  riposo quando Ã¨ inattivo e inizia a rallentare; durante la modalitÃ  riposo si attiva la produzione offline di B/s",
	"Music in background": "Musica in sottofondo",
	"music will keep playing even when the game window isn't focused": "la musica continuerÃ  a suonare anche quando la finestra di gioco non Ã¨ piÃ¹ in primo piano",
	...
	"Screen reader mode": "ModalitÃ  lettura dello schermo",
	"allows optimizations for screen readers; game will reload": "consente ottimizzazioni per le utilitÃ  per la lettura dello schermo; la partita verrÃ  ricaricata",
	"Discord status": "Stato su Discord",
	"if Discord is on, show your game info as activity status": "Se Discord Ã¨ attivo, mostra le tue informazioni di gioco come stato dell'attivitÃ ",
	"Language": "Lingua",
	"Language: %1": "Lingua: %1",
	"Change language": "Modifica lingua",
	"note: this will save and reload your game": "nota: la partita verrÃ  salvata e ricaricata",
	...
	"These are feats that are either unfair or difficult to attain. They do not give milk.": "Queste imprese non sono ingiuste nÃ© difficili da completare. Non ricevi latte.",
	...
	"Milk is gained with each achievement. It can unlock unique upgrades over time.": "Ottieni latte per ogni obiettivo raggiunto. Nel tempo puÃ² sbloccare potenziamenti unici.",
	"Rank %1": "Grado %1",
	"Automatic": "Auto",
	...
	"Cookie Clicker is a javascript game by %1 and %2.": "Cookie Clicker Ã¨ un gioco in javascript sviluppato da %1 e %2.",
	"Music by %1.": "Muscia di %1.",
	"Useful links: %1, %2, %3, %4.": "Link utili: %1, %2, %3, %4.",
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1": "L'attuale versione di Cookie Clicker Ã¨ completamente gratuita e lo sarÃ  per sempre. Vuoi aiutarci a sviluppare altri giochi? Ecco cosa puoi fare:%1",
	...
	"Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!": "Avvertenza: eliminando la cache o i cookie <small>(e perchÃ© mai vorresti farlo?)</small> del browser, cancellerai il tuo salvataggio. Ricordati di esportarlo ed eseguire un backup prima di procedere!",
	...
	"This feature is not yet available in your language.": "Questa funzionalitÃ  non Ã¨ ancora disponibile nella tua lingua.",
	"Restart with new changes": "Riavvia con nuove modifiche",
	"Cookie Clicker is in sleep mode.": "Cookie Clicker Ã¨ in modalitÃ  riposo.",
	"Cookie Clicker is in sleep mode and generating offline cookies.": "Cookie Clicker Ã¨ in modalitÃ  riposo e sta generando biscotti offline.",
	...
	"This is your save code.<br>Copy it and keep it somewhere safe!": "Questo Ã¨ il codice del tuo salvataggio.<br>Copialo e conservalo in un luogo sicuro!",
	...
	"Enable": "Attiva",
	"Disable": "Disattiva",
	"Priority up": "PrioritÃ  su",
	"Priority down": "PrioritÃ  giÃ¹",
	"New mod": "Nuova mod",
	...
	"Error!": "Errore!",
	"none": "nessuna",
	"Publishing...": "Pubblicazione in corsoâ€¦",
	"Updating...": "Aggiornamento in corsoâ€¦",
	"Success!": "Operazione riuscita!",
	"Refresh": "Aggiorna",
	"Last update:": "Ultimo aggiornamento:",
	"Mods are loaded from top to bottom.": "Le mod vengono caricate dall'alto al basso.",
	"Some mods couldn't be loaded:": "Non Ã¨ stato possibile caricare alcune mod:",
	...
	"Easter": "Pasqua",
	"Halloween": "/",
	"%1 has started!": "L'evento di %1 Ã¨ iniziato!",
	"%1 is over.": "L'evento di %1 Ã¨ terminato.",
	"%1's bakery": "Pasticceria %1",
	"Name your bakery": "Dai un nome alla pasticceria",
	"What should your bakery's name be?": "Quale sarÃ  il nome della tua pasticceria?",
	...
	"A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.": "Una <b>zolletta di zucchero</b> Ã¨ in corso di formazione, attratta dai tuoi successi.",
	...
	"&bull; Sugar lumps can be harvested when mature, though if left alone beyond that point they will start ripening (increasing the chance of harvesting them) and will eventually fall and be auto-harvested after some time.<br>&bull; Sugar lumps are delicious and may be used as currency for all sorts of things.<br>&bull; Once a sugar lump is harvested, another one will start growing in its place.<br>&bull; Note that sugar lumps keep growing when the game is closed.": "â€¢ Puoi raccogliere subito le zollette di zucchero cresciute, oppure lasciarle maturare (aumentando le possibilitÃ  di raccolta); dopo un certo periodo di tempo, cadranno e verranno raccolte automaticamente.<br>â€¢ Le zollette di zucchero sono deliziose e possono essere utilizzare come valuta per vari scopi.<br>â€¢ Una volta raccolta una zolletta di zucchero, un'altra inizierÃ  a crescere al suo posto.<br>â€¢ Ricorda che le zollette di zucchero continuano a crescere anche dopo la chiusura del gioco.",
	...
	"This sugar lump is still growing and will take <b>%1</b> to reach maturity.": "Questa zolletta di zucchero sta ancora crescendo e sarÃ  pronta tra <b>%1</b>.",
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.": "Questa zolletta di zucchero Ã¨ cresciuta e maturerÃ  tra <b>%1</b>.<br>Puoi <b>fare clic per raccoglierla subito</b>, ma c'Ã¨ <b>una probabilitÃ  del 50% di non ottenere nulla</b>.",
	"<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.": "<b>Questa zolletta di zucchero Ã¨ matura! Fai clic per raccoglierla.</b><br>Se non intervieni, verrÃ  raccolta automaticamente tra <b>%1</b>.",
	"This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.": "Questa zolletta di zucchero Ã¨ diventata <b>biforcuta</b>; se la raccogli, avrai il 50% di probabilitÃ  di ottener due zollette.",
	"This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.": "Questa zolletta di zucchero Ã¨ diventata <b>dorata</b>; se la raccogli potrai ottenere da 2 a 7 zollette, la tua quantitÃ  di biscotti attuale verrÃ  raddoppiata (fino a un valore equivalente a 24 ore dei B/s) e avrai il 10% in piÃ¹ di probabilitÃ  di trovare biscotti dorati nelle prossime 24 ore.",
	"This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.": "Questa zolletta di zucchero Ã¨ stata influenzata dalle anziane ed Ã¨ diventata <b>succosa</b>; se la raccogli potrai ottenere da 0 a 2 zollette.",
	"This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.": "Questa zolletta di zucchero Ã¨ diventata <b>caramellata</b> e si Ã¨ appiccicata a sorprese inaspettate; se la raccogli potrai ottenere da 1 a 3 zollette e azzerare i tempi di ricarica delle zollette.",
	...
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.": "Impossibile caricare gli araldi. Potrebbe essersi verificato un problema interno ai nostri server, oppure stai giocando in modalitÃ  locale.",
	...
	"To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.": "Per ottenere il bonus degli araldi hai bisogno di un potenziamento che non possiedi ancora. Lo sbloccherai permanentemente piÃ¹ avanti nel gioco.",
	...
	"Cookie blab": [
		"FriabilitÃ  dei biscotti x3 per 60 secondi!",
		"Potenza cioccolatosa x7 per 77 secondi!",
		"ElasticitÃ  dell'impasto dimezzata per 66 secondi!",
		...
		"Il tuo clic Ã¨ stato registrato. Grazie per la collaborazione.",
	...
	"Your dragon is fully trained.": "Il tuo drago Ã¨ completamente addestrato.",
	...
	"Switching your aura is <b>free</b> because you own no buildings.": "Cambiare l'aura Ã¨ <b>gratuito</b> perchÃ© non possiedi strutture.",
	"The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!": "Cambiare l'aura ti costerÃ  <b>%1</b>.<br>AvrÃ  effetto sui B/s!",
	...
	"Reality Bending": "Manipolazione della realtÃ ",
	...
	"Ticker (grandma)": [
		...
		"PerchÃ© non vieni mai a trovarmi?",
		"Chiamami..."
	],
	...
	"Ticker (grandma invasion rise)": [
		"intere cittÃ  nel panico, anziane signore irrompono nelle case per rapire bambini e utensili da pasticceria!",
	...
	"Ticker (grandma invasion full)": [
		...
		"ogni speranza Ã¨ perduta, una massa fremente di carne e impasto ha fagocitato un'intera cittÃ !",
		"l'incubo continua, gli ettari di carne grinzosa si espandono a una velocitÃ  allarmante!"
	],
	"Ticker (Farm)": [
	...
	"Ticker (Mine)": [
		...
		"scoperte \"strane creature cioccolatose\" che dimorano nelle profonditÃ  delle miniere di cioccolato!"
	],
	"Ticker (Factory)": [
	...
	"Ticker (Wizard tower)": [
		...
		"maghi dei biscotti negano ogni coinvolgimento nella nascita di un bebÃ¨ spaventosamente orribile; secondo i dottori, il neonato Ã¨ \"francamente rivoltante, ma naturale\".",
		"\"Qualsiasi magia sufficientemente rudimentale Ã¨ indistinguibile dalla tecnologia\", afferma un noto tecnomago."
	],
	"Ticker (Shipment)": [
		"scoperto un nuovo pianeta di cioccolato, sarÃ  destinazione delle astronavi mercantili!",
	...
	"Ticker (Alchemy lab)": [
		"la riserva aurea nazionale si assottiglia, quantitÃ  sempre piÃ¹ ingenti del prezioso materiale vengono trasformate in biscotti!",
		"la scienza afferma anche l'argento puÃ² essere trasformato in cioccolato bianco!",
		"chiude un laboratorio alchemico difettoso, trasformava biscotti in inutile oro."
	],
	"Ticker (Portal)": [
		"preoccupazione nel paese, sempre piÃ¹ creature inquietanti emergono dai portali dimensionali!",
		"turismo nel biscoverso popolare tra gli adolescenti annoiati! Il tasso di mortalitÃ  si attesta al 73%!",
		"secondo uno studio, i portali del biscoverso sarebbero causa di invecchiamento precoce e ossessione per la pasticceria."
	],
	"Ticker (Time machine)": [
		"macchine del tempo coinvolte in uno scandalo di riscrittura della storia! SarÃ  proprio cosÃ¬?",
		"secondo uno storico, i biscotti portati dal passato sono \"inadeguati al consumo umano\".",
		"\"Ho visto il futuro\", afferma un operatore di macchine del tempo, \"e non desidero tornarci mai piÃ¹\"."
	],
	"Ticker (Antimatter condenser)": [
		"un'intera cittÃ  sembra essere stata inghiottita da un buco nero causato dall'antimateria; fonti affidabili affermano che la cittÃ  \"non Ã¨ mai esistita\"!",
		"ricercatori concludono che la prima e fondamentale necessitÃ  dell'industria dei biscotti Ã¨ \"piÃ¹ magneti\".",
		"attivato con successo il primo condensatore di antimateria, non lacera la realtÃ !"
	],
	"Ticker (Prism)": [
		...
		"i biscotti vengono letteralmente preparati alla velocitÃ  della luce grazie ai nuovi marchingegni prismatici.",
	...
	"Ticker (Chancemaker)": [
		...
		"casinÃ² locale in rovina, dopo che i giocatori d'azzardo hanno totalizzato un'intera settimana di vincite! \"Potremmo ancora riprenderci\", afferma il titolare prima di essere colpito 47 volte da un fulmine.",
		"per una casuale fatalitÃ , il paese vicino elegge un presidente con politiche sensate!"
	],
	"Ticker (Fractal engine)": [
		"abitante del posto ha \"chiuso con Cookie Clicker\", trova le frasi autoreferenziali \"irritati e scontate\".",
		"guru locale afferma che \"in ognuno c'Ã¨ una piccola parte di noi\", indagato per sospetto cannibalismo.",
		"dai sondaggi risulta che l'idea di biscotti fatti di biscotti Ã¨ \"accettabile\"; uno dei cittadini intervistati afferma: \"Almeno ora sappiamo cosa contengono.\""
	],
	"Ticker (Javascript console)": [
		"codificare Ã¨ di moda! Sempre piÃ¹ adolescenti si interessano agli ambiti tecnici come quello della programmazione, garantendo una futura apocalisse robot e la distruzione dell'intero genere umano.",
		"sviluppatori incerti sul nome delle nuove librerie javascript, tutte le combinazioni di 3 parole sono giÃ  state utilizzate.",
	...
	"Ticker (Idleverse)": [
		...
		"\"Trovo conforto nella consapevolezza che lÃ  fuori qualche mia versione alternativa se la stia cavando alla grande\", afferma l'ultimo esemplare di cittadino nel multiverso.",
		"fumettisti puntano il dito contro il vero multiverso in difesa di controversi buchi di trama. \"Visto? Lo dicevo che non era banale nÃ© forzato!\""
	],
	"Ticker (Cortex baker)": [
		...
		"si ricorda ai dipendenti che i cervelli artificiali panettieri sono materiale di proprietÃ  della panetteria e non permesso dargli soprannomi per ingraziarseli."
	],
	"Ticker (Halloween)": [
	...
	"Ticker (Christmas)": [
		...
		"pazzo obeso e gioviale ancora a piede libero, avvertono gli agenti. \"Tenete i bambini al sicuro e barricate i camini. Non Ã¨ uno scherzo.\"",
		"secondo le autoritÃ , la misteriosa entitÃ  natalizia con poteri quantici continua a seminare scompiglio con un esercito di renne.",
		"\"Vorreste dire che porta regali gratuitamente?!\", chiedono madri preoccupate. \"Personalmente, non mi fido della sua barba.\"",
		"bambini sconvolti scoprono che in fondo Babbo Natale non Ã¨ papÃ  con un costume!<br>\"In questo momento sto rivalutando la mia vita\", confida Laura, 6 anni."
	],
	"Ticker (Valentines)": [
		"secondo gli esperti meteorologi, l'amore Ã¨ nell'aria. In ogni cittÃ  vengono offerte mascherine per evitare l'infezione aerea.",
	...
	"Ticker (Easter)": [
		...
		"conigli ovaioli \"da un'altra dimensione\", avverte un biologo; Ã¨ sconsigliato accarezzare, nutrire o cucinare le creature.",
		"scoperta la capacitÃ  dei misteriosi conigli di deporre uova pur essendo mammiferi, indicando una probabile discendenza dagli ornitorinchi."
	],
	"Ticker (misc)": [
		...
		"\"Non sono biscotto-dipendente. Sono solo illazioni di fan con troppo tempo libero\", rivela una celebritÃ .",
		"\"Va bene, lo ammetto, non ho mai mangiato un biscotto in vita mia\", rivela una celebritÃ .",
		"\"I biscotti mi hanno permesso di rimanere in forma e in salute\", rivela una celebritÃ .",
		"ladro rapina una banca per comprare biscotti.",
		"nuovo studio suggerisce che i biscotti non accelerino nÃ© rallentino l'invecchiamento, ma che ci portino \"in una direzione differente\".",
		"uomo scopre di essere intollerante ai biscotti; \"Che svitato\", commenta la famiglia.",
		"carestia di biscotti colpisce una cittÃ , abitanti costretti a mangiare cupcake; \"Non Ã¨ la stessa cosa\", ammette il sindaco.",
		"\"Bisogna ammettere che questa storia dei biscotti Ã¨ piuttosto inquietante\", dichiara un idiota squilibrato.",
	...
	"Your cookies are renowned in the whole town!": "I tuoi biscotti sono famosi in tutta la cittÃ !",
	...
	"A national day has been created in honor of your cookies.": "Ãˆ stata creata una festa nazionale in onore dei tuoi biscotti.",
	...
	"Elder gods from the whole cosmos have awoken to taste your cookies.": "Antichi dÃ¨i di interi universi si sono risvegliati per assaggiare i tuoi biscotti.",
	...
	"The universe has now turned into cookie dough, to the molecular level.": "Ogni singola molecola dell'universo si Ã¨ trasformata in impasto per biscotti.",
	...
	"it's time to stop playing": "Ã¨ ora di smettere di giocare",
	"Today is your lucky day!": "Non Ã¨ il tuo giorno fortunato!",
	"Your lucky numbers are:": "I tuoi numeri fortunati sono:",
	"Fortune!": "Che fortuna!",
	"A golden cookie has appeared.": "Ãˆ comparso un biscotto dorato.",
	"You gain <b>one hour</b> of your CpS (capped at double your bank).": "Ottieni una quantitÃ  pari a <b>un'ora</b> dei B/s (fino al doppio di quanto possiedi).",
	...
	"Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)": "Il tuo livello di prestigio attuale Ã¨ <b>%1</b>.<br>(+%2% B/s)",
	...
	"Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.": "Ogni livello di prestigio garantisce un bonus permanente di <b>+%1% B/s</b>.<br>PiÃ¹ livelli possiedi, maggiore la quantitÃ  di biscotti richiesta.",
	...
	"Click this once you've bought<br>everything you need!": "Fai clic quando hai acquistato<br>tutto ciÃ² che ti serve!",
	"Are you ready to return to the mortal world?": "Ãˆ il momento di tornare al mondo dei mortali?",
	"Hello, cookies!": "EhilÃ , biscotti!",
	"Challenge mode for the next run:": "ModalitÃ  sfida per la prossima campagna:",
	"Challenge modes apply special modifiers to your next ascension.<br>Click to change.": "Le modalitÃ  sfida applicano speciali modificatori alla tua ascensione successiva.<br>Fai clic per cambiare.",
	"Select a challenge mode": "Seleziona una modalitÃ  sfida",
	"None [ascension type]": "Nessuna",
	"No special modifiers.": "Nessun modificatore speciale.",
	"Born again [ascension type]": "Rinascita",
	"This run will behave as if you'd just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar lumps and building levels. Perma-upgrades and minigames will be unavailable.<div class=\"line\"></div>Some achievements are only available in this mode.": "In questa campagna sarÃ  come se avessi ricominciato da zero. I livelli di prestigio e i potenziamenti celestiali non avranno effetto, cosÃ¬ come eventuali zollette di zucchero e livelli delle strutture. I potenziamenti permanenti e i minigiochi non saranno disponibili.<div class=\"line\"></div>Alcuni obiettivi sono disponibili solo in questa modalitÃ .",
	...
	"Valentine's Day!": "San Valentino!",
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!": "à§„Ãˆ la <b>stagione di San Valentino</b>!<br>L'amore Ã¨ nell'aria e i biscotti sono davvero piÃ¹ dolci!",
	"Business Day!": "Aprile aziendale!",
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.": "à§„Ãˆ la <b>stagione di Aprile aziendale</b>!<br>Niente panico! Per qualche giorno tutto avrÃ  un aspetto piÃ¹ imprenditoriale.",
	"Halloween!": "/",
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!": "à§„Ãˆ la <b>stagione di Halloween</b>!<br>Tutto Ã¨ leggermente piÃ¹ spettrale!",
	"Christmas time!": "Natale!",
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!": "à§„Ãˆ la <b>stagione di Natale</b>!<br>Diffondi il buonumore, potrai trovare dei biscotti nella calza!",
	"Easter!": "Pasqua!",
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!": "à§„Ãˆ la <b>stagione di Pasqua</b>!<br>Tieni gli occhi aperti, potresti fare clic su qualche coniglio di passaggio!",
	...
	"Upgrade is vaulted and will not be auto-purchased.": "Il potenziamento si trova nel deposito e non verrÃ  acquistato automaticamente.",
	...
	"Granting <b>+%1% %2 CpS</b>.": "Garantiscono <b>+%1% B/s ottenuti da queste unitÃ : %2</b>.",
	...
	"level up your %1": "aumenta il livello di queste unitÃ : %1",
	"Mute": "Minimizza",
	...
	"You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.": "Puoi premere %1 per acquistare o vendere in una volta sola %2 unitÃ  di una struttura, o %3 per %4 unitÃ .",
	...
	"[Grandma quote]A nice grandma to bake more cookies.": "Un'adorabile nonna per infornare piÃ¹ biscotti.",
	...
	"[Farm business quote]The more kitchens, the more cookies your employees can produce.": "Maggiore il numero di cucine, piÃ¹ biscotti potranno sfornare i tuoi dipendenti.",
	"Mine": "Miniera",
	"mine": "miniera",
	"mines": "miniere",
	"%1 mine": [
	...
	"[Factory quote]Produces large quantities of cookies.": "Produce enormi quantitÃ  di biscotti.",
	"[Factory business name]Factory": "Fabbrica",
	"[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!": "La produzione di massa Ã¨ il futuro della pasticceria. Cogli l'attimo e sinergizza!",
	"Bank": "Banca",
	"bank": "banca",
	"banks": "banche",
	"%1 bank": [
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.": "Gente d'affari con un fiuto per il profitto, pronta a finanziare la tua impresa finchÃ© garantisce un ritorno economico.",
	"Temple": "Tempio",
	"temple": "tempio",
	"temples": "templi",
	"%1 temple": [
	...
	"[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.": "La tua pagina social sta diventando virale! Accumulare mi piace Ã¨ essenziale per una duratura presenza online e succulenti contratti pubblicitari.",
	...
	"[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.": "Valuta virtuale che in alcuni piccoli paesi sta giÃ  sostituendo la moneta corrente.",
	"Prism": "Prisma",
	"prism": "prisma",
	"prisms": "prismi",
	"%1 prism": [
	...
	"[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.": "Una dottrina puÃ² assumere molte forme (religione, cultura, filosofia) e, se utilizzata opportunamente, puÃ² provocare un impatto duraturo sulle civiltÃ , plasmando menti e persone e facendo in modo che tutte le generazioni future condividano un obiettivo comune: la produzione e l'acquisizione di piÃ¹ biscotti.",
	...
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!": "Accanto alla nostra realtÃ  si dispiegano innumerevoli universi passivi. Finalmente hai trovato un modo per sabotare la loro produzione e trasformare qualsiasi cosa abbiano realizzato in biscotti!",
	"[Idleverse business name]Lateral expansions": "Espansioni trasversali",
	"[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.": "A volte la scelta migliore Ã¨ muoversi trasversalmente. Diversifica le tue imprese con investimenti esterni ai biscotti.",
	...
	"[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.": "Questi cervelli artificiali dalle dimensioni planetarie sono in grado di far materializzare biscotti con la sola forza del pensiero. Per loro spazio e tempo sono irrilevanti. La realtÃ  Ã¨ un concetto relativo.",
	"[Cortex baker business name]Think tank": "Pensatoio",
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!": "Ci sono cosÃ¬ tanti modi con cui puoi aumentare i profitti. O forse no? Assumi gli esperti piÃ¹ brillanti dell'universo conosciuto e lascia che si spremano le meningi per te!",
	"CpS": "BpS",
	...
	"wrinkler spawn rate": "velocitÃ  ricomparsa divoratori",
	"wrinkler appetite": "appetito divoratori",
	"upgrade costs": "costo del potenziamento",
	"building costs": "costo della struttura",
	"Clicking is <b>%1%</b> more powerful.": "I clic sono piÃ¹ potenti del <b>%1%</b>.",
	"All cookie production <b>multiplied by %1</b>.": "Tutta la produzione di biscotti Ã¨ <b>moltiplicata per %1</b>.",
	"+%1 CpS": "+%1 B/s",
	"+%1% base CpS.": "+%1% BpS base.",
	"%1 are <b>twice</b> as efficient.": "<b>Raddoppia</b> l'efficienza di queste unitÃ : %1.",
	"%1 are <b>%2%</b> more powerful.": "<b>Aumenta del %2%</b> la potenza di queste unitÃ : %1.",
	...
	"Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.": "Libera dalle catene tutti i <b>potenziamenti di livello %1</b>, rendendoli piÃ¹ potenti.<br>Applicabile solo a strutture senza catene.",
	...
	"You gain <b>more CpS</b> the more milk you have.": "PiÃ¹ latte possiedi, <b>piÃ¹ B/s</b> ottieni.",
	"Milk is <b>%1% more powerful</b>.": "Il latte Ã¨ <b>piÃ¹ potente del %1%</b>.",
	...
	"%1 gain <b>+%2%</b> CpS per %3.": "Queste unitÃ  ottengono <b>+%2%</b> B/s ogni %3: %1.",
	"Multiplies the gain from %1 by <b>%2</b>.": "Moltiplica per <b>%2</b> la rendita di queste unitÃ : %1.",
	"Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.": "Centro ricreativo e laboratorio scientifico gestito dalle nonne.<br>Le nonne sono <b>4 volte</b> piÃ¹ efficienti.<br><b>Sblocca regolarmente nuovi potenziamenti</b>.",
	...
	"Note: this is a bad idea.": "Nota: Ã¨ davvero una pessima idea.",
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?": "<b>Avvertenza:</b> questo acquisto porterÃ  risultati inattesi e potenzialmente indesiderabili!<br><small>Da qui Ã¨ tutta discesa. Consideralo un avvertimento!</small><br><br>Vuoi procedere comunque?",
	...
	"With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.": "Se non ci sono bonus o biscotti dorati sullo schermo, vendere la struttura piÃ¹ potente garantisce il <b>%1% di probabilitÃ  di evocarne uno</b>.",
	...
	"Subsequent research will be <b>%1 times</b> as fast.": "Le ricerche successive saranno <b>%1 volte</b> piÃ¹ rapide.",
	"Wrinklers appear <b>%1 times</b> as fast.": "I divoratori compariranno <b>%1 volte</b> piÃ¹ rapidamente.",
	...
	"Cost scales with how many eggs you own.": "Il costo varia in base alla quantitÃ  di uova possedute.",
	...
	"Reindeer are <b>twice as slow</b>.": "<b>Dimezza la velocitÃ </b> delle renne.",
	...
	"All buildings are <b>%1% cheaper</b>.": "Il costo di tutte le strutture Ã¨ <b>ridotto del %1%</b>.",
	"All upgrades are <b>%1% cheaper</b>.": "Il costo di tutti i potenziamenti Ã¨ <b>ridotto del %1%</b>.",
	"All buildings and upgrades are <b>%1% cheaper</b>.": "Il costo di tutte le strutture e i potenziamenti Ã¨ <b>ridotto del %1%</b>.",
	"%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.": "Aumenta del <b>%2%</b> l'efficienza di queste unitÃ : %1; il loro costo Ã¨ ridotto del <b>%3%</b>.",
	"Cookie upgrades are <b>%1 times cheaper</b>.": "I potenziamenti biscotto sono <b>%1 volte meno costosi</b>.",
	"Random drops are <b>%1% more common</b>.": "<b>Aumenta del %1%</b> la probabilitÃ  di ritrovamenti casuali.",
	...
	"Cookie production <b>multiplied by 1,000</b>.": "La produzione di biscotti Ã¨ <b>moltiplicata per 1.000</b>.",
	...
	"Heart cookies are <b>%1%</b> more powerful.": "I biscotti cuore sono piÃ¹ potenti del <b>%1%</b>.",
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.": "<b>PiÃ¹ a lungo giochi all'ascensione attuale, maggiore la quantitÃ  di B/s</b> che guadagni in modo continuato.",
	...
	"You gain another <b>+%1%</b> of your regular CpS while the game is closed.": "Ottieni un ulteriore <b>+%1%</b> dei tuoi B/s standard quando il gioco Ã¨ chiuso.",
	"You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.": "Ottieni un ulteriore <b>+%1%</b> dei tuoi B/s standard quando il gioco Ã¨ chiuso, per un totale pari al <b>%2%</b>.",
	...
	"Synergy upgrades are <b>%1% cheaper</b>.": "Il costo dei potenziamenti sinergia Ã¨ <b>ridotto del %1%</b>.",
	"You retain optimal cookie production while the game is closed for <b>%1 more days</b>.": "Mantieni una produzione ottimale di biscotti per <b>%1 giorni aggiuntivi</b> quando il gioco Ã¨ chiuso.",
	"You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.": "Raddoppia il tempo di mantenimento di una produzione ottimale di biscotti quando il gioco Ã¨ chiuso, per un totale di <b>%1</b>.",
	...
	"Contains more exotic flavors for your milk selector.": "Contiene gusti piÃ¹ esotici per il selettore di latte.",
	...
	"This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class=\"line\"></div>Each time you ascend, the cookies you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class=\"line\"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class=\"line\"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.": "Questo Ã¨ il primo potenziamento celestiale, che sblocca il sistema delle <b>scaglie celestiali</b>.<div class=\"line\"></div>A ogni ascensione, i biscotti ottenuti nella vita precedente sono trasformati in <b>scaglie celestiali</b> e <b>prestigio</b>.<div class=\"line\"></div>Puoi spendere le <b>scaglie celestiali</b> per acquistare diversi potenziamenti trascendentali permanenti.<div class=\"line\"></div>Ogni <b>livello di prestigio</b> ti conferisce inoltre <b>+1% B/s</b>.",
	...
	"All upgrades are <b>%1% cheaper per %2</b>.": "Il costo di tutti i potenziamenti Ã¨ <b>ridotto del %1% ogni %2</b>.",
	"Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.": "Sblocca una nuova classe di potenziamenti, che hanno effetto su <b>2 strutture in contemporanea</b>.<br>Le sinergie compaiono una volta costruite <b>%1</b> unitÃ  di entrambe le strutture.",
	"Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.": "I biscotti dorati (e gli altri oggetti generati, tra cui le renne) hanno il <b>%1% di probabilitÃ  di raddoppiarsi</b>.",
	"Cookie production <b>reduced to 0</b>.": "La produzione di biscotti Ã¨ <b>ridotta a 0</b>.",
	"Sugar lumps coalesce <b>a whole lot faster</b>.": "Le zollette di zucchero si formano <b>molto piÃ¹ rapidamente</b>.",
	"<b>+%1%</b> prestige level effect on CpS.": "Effetto dei livelli di prestigio sui B/s pari a <b>+%1%</b>.",
	"<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.": "Effetto dei livelli di prestigio sui B/s pari a <b>+%1%</b>.<br>Durata dell'effetto dei biscotti dorati <b>+%2%</b>.<br>LongevitÃ  dei biscotti dorati <b>+%3%</b>.",
	"Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class=\"warning\">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>": "Ogni zolletta di zucchero inutilizzata (fino a un limite di %1) fornisce <b>+%2% B/s</b>.<div class=\"warning\">Nota: ciÃ² significa che, una volta spese le zollette, i B/s sono ridotti finchÃ© non si formano nuovamente.</div>",
	...
	"Sugar lumps are <b>twice as likely</b> to be unusual.": "<b>Raddoppia la probabilitÃ </b> di ottenere zollette di zucchero insolite.",
	"<b>+%1%</b> sugar lump growth.": "Crescita delle zollette di zucchero <b>aumentata del %1%</b>.",
	"Sugar lumps ripen <b>%1</b> sooner.": "Il tempo di maturazione delle zollette di zucchero Ã¨ ridotto di <b>%1</b>.",
	"Sugar lumps mature <b>%1</b> sooner.": "Il tempo di crescita delle zollette di zucchero Ã¨ ridotto di <b>%1</b>.",
	"Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.": "<b>Aumenta del %1% la comparsa</b> di zollette di zucchero biforcute e <b>del %2% la probabilitÃ </b> di ottenere 2 zollette da esse.",
	...
	"Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.": "Hai <b>1 possibilitÃ  su 5</b> di conservare i ritrovamenti casuali stagionali dopo l'ascensione.",
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.": "Sblocca <b>informazioni aggiuntive sul prezzo</b>.<br>Ora i costi visualizzati specificano il tempo necessario a coprirli e a quanto corrispondono rispetto a ciÃ² che possiedi.",
	"Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.": "Sblocca il <b>velo lucente</b>, che conferisce ai B/s un bonus passivo del <b>%1%</b>.<br>Inizi la partita con il velo attivo, ma Ã¨ molto fragile; facendo clic sul biscotto gigante, sui biscotti dorati o sulle renne lo romperai e potrai attivarlo nuovamente spendendo %2 di B/s.",
	"Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.": "Se attivato, migliora la produzione di biscotti del <b>%1%</b>.<br>Il velo Ã¨ molto fragile e verrÃ  lacerato da ogni clic sul biscotto gigante, sui biscotti dorati o sulle renne.<br><br>Una volta lacerato, potrai riattivarlo al costo di %2 di B/s senza bonus.",
	"Has a <b>%1%</b> chance to not break.": "Ha il <b>%1%</b> di probabilitÃ  di non lacerarsi.",
	"The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.": "Il <b>velo lucente</b> Ã¨ piÃ¹ resistente e ha il <b>%1% di probabilitÃ </b> di non lacerarsi. Garantisce inoltre <b>+%2%</b> B/s aggiuntivi.",
	"Active.": "Attivo.",
	...
	"Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.": "Prima di acquistare il potenziamento <b>%1</b> durante una campagna, i ritrovamenti casuali sono <b>%2 volte piÃ¹ probabili</b>.",
	"Never forget your %1.": "Non dimenticare mai queste unitÃ : %1.",
	"Pay close attention to the humble %1.": "Fai molta attenzione a queste umili unitÃ : %1.",
	"You've been neglecting your %1.": "Hai trascurato queste unitÃ : %1.",
	"Remember to visit your %1 sometimes.": "Ricorda di visitare queste unitÃ : %1.",
	"You don't know what you have until you've lost it.": "Non ti accorgi di ciÃ² che possiedi finchÃ© non lo perdi.",
	"Remember to take breaks.": "Ricorda di fare qualche pausa.",
	"Hey, what's up. I'm a fortune cookie.": "EhilÃ . Sono un biscotto della fortuna.",
	...
	"Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.": "Grazie a un'accorta contabilitÃ , il prezzo dei potenziamenti felini Ã¨ <b>ridotto del %1%</b>.",
	"Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.": "Sblocca la possibilitÃ  di <b>coccolare il tuo drago</b> con un clic quando l'uovo si schiude.",
	"Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.": "Il costo varia in base ai B/s, ma Ã¨ %1 volte piÃ¹ economico con un drago completamente addestrato.",
	...
	"Dragon harvest and Dragonflight are <b>%1% stronger</b>.": "Raccolto del drago e Volo di drago sono <b>piÃ¹ potenti del %1%</b>.",
	"Kittens are <b>%1%</b> more effective.": "I felini sono piÃ¹ potenti del <b>%1%</b>.",
	"Each kitten upgrade boosts %1 CpS by <b>%2%</b>.": "Ogni potenziamento felino migliora del <b>%2%</b> i B/s forniti da queste unitÃ : %1.",
	"Each rank of milk boosts %1 CpS by <b>%2%</b>.": "Ogni grado di latte migliora del <b>%2%</b> i B/s forniti da queste unitÃ : %1.",
	...
	"Golden and wrath cookies appear %1% more.": "I biscotti dorati e iracondi si materializzano il %1% piÃ¹ spesso.",
	...
	"Switching seasons is %1% pricier.": "Cambiare stagione Ã¨ piÃ¹ caro del %1%.",
	"Switching seasons is %1% cheaper.": "Cambiare stagione Ã¨ meno caro del %1%.",
	"Heavenly chips have %1% less effect.": "L'effetto delle scaglie celestiali Ã¨ inferiore al %1%.",
	"Buildings produce %1% more.": "Le strutture producono il %1% in piÃ¹.",
	"Buildings produce %1% less.": "Le strutture producono il %1% in meno.",
	"All golden cookies are wrath cookies with a greater chance of a negative effect.": "Tutti i biscotti dorati sono biscotti iracondi con probabilitÃ  maggiore di un effetto negativo.",
	"Wrinklers appear %1% faster and digest %2% more cookies.": "I divoratori si materializzano il %1% piÃ¹ velocemente e digeriscono il %2% in piÃ¹ di biscotti.",
	"Effect is only active when your total amount of buildings ends with 0.": "L'effetto Ã¨ attivo solo se la quantitÃ  totale delle tue strutture termina con uno 0.",
	"Achievement unlocked": "Obiettivo sbloccato",
	"Make <b>%1</b> just from %2.": "Produci <b>%1</b> con queste unitÃ : %2.",
	...
	"Have <b>at least %1</b> of every building.": "Possiedi <b>almeno %1 unitÃ </b> di ogni struttura.",
	"Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).": "Possiedi almeno <b>1 unitÃ  dell'oggetto piÃ¹ costoso, 2 unitÃ  del secondo oggetto piÃ¹ costoso, 4 unitÃ  di quello successivo</b> e cosÃ¬ via (fino a un massimo di %1).",
	"Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.": "Possiedi almeno <b>10 unitÃ  dell'oggetto piÃ¹ costoso, 20 unitÃ  del secondo oggetto piÃ¹ costoso, 30 unitÃ  di quello successivo</b> e cosÃ¬ via.",
	...
	"Click really, really fast.": "Fai clic a tutta velocitÃ .",
	"Have at least <b>%1 of everything</b>.": "Possiedi almeno <b>%1 unitÃ  di ogni oggetto</b>.",
	...
	"You have <b>1 chance in %1</b> every second of earning this achievement.": "Ogni secondo hai <b>1 probabilitÃ  su %1</b> di ottenere questo obiettivo.",
	...
	"Name yourself <b>Orteil</b>.<div class=\"warning\">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>": "Cambia il nome in <b>Orteil</b>.<div class=\"warning\">Nota: gli usurpatori subiranno una penalitÃ  di -%1% B/s fino a quando non modificheranno nuovamente il nome.</div>",
	...
	"Own a combined <b>%1</b> %2 and %3.": "Possiedi <b>%1</b> unitÃ  tra %2 e %3.",
	...
	"Fill every tile of the biggest garden plot with plants.": "Riempi di piante ogni spazio disponibile nel lotto piÃ¹ grande del giardino.",
	...
	"Unlock the <b>highest-tier</b> stock market headquarters.": "Sblocca la <b>classe piÃ¹ alta</b> della sede del mercato azionario.",
	...
	"%1 Power!": "Accelerazione di tutte le unitÃ  %1!",
	"%1 Burden!": "Rallentamento di tutte le unitÃ  %1!",
	...
	"All buildings are %1% cheaper for %2!": "Il costo di tutte le strutture Ã¨ ridotto del %1% per %2!",
	"All buildings are %1% pricier for %2!": "Il costo di tutte le strutture Ã¨ aumentato del %1% per %2!",
	"All upgrades are %1% cheaper for %2!": "Il costo di tutti i potenziamenti Ã¨ ridotto del %1% per %2!",
	"All upgrades are %1% pricier for %2!": "Il costo di tutti i potenziamenti Ã¨ aumentato del %1% per %2!",
	...
	"Spells backfire %1 times less for %2.": "ProbabilitÃ  di fallimento degli incantesimi ridotta di %1 volte per %2.",
	"Spells backfire %1 times more for %2.": "ProbabilitÃ  di fallimento degli incantesimi aumentata di %1 volte per %2.",
	...
	"Details:": "Dettagli:",
	"Effects:": "Effetti:",
	"Effect is active.": "L'effetto Ã¨ attivo.",
	"Effect is inactive.": "L'effetto non Ã¨ attivo.",
	...
	"[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.": "Una varietÃ  di granturco dalla forma particolare. Ogni seme produce generalmente un numero a cifra singola di germogli.",
	"Cronerice": "Riso della megera",
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.": "Questo bulbo raggrinzito non somiglia affatto al riso e non appartiene nemmeno alla stessa specie; il suo parente piÃ¹ stretto Ã¨ il salice piangente.",
	...
	"[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.": "<i>Trifolium repens</i>, una varietÃ  di trifoglio piuttosto ordinaria che tende a produrre quattro foglie. Molti ritengono che questa circostanza sia segno di buona sorte.",
	"Golden clover": "Trifoglio dorato",
	"[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.": "Una varietÃ  del trifoglio comune, che ha rinunciato alla clorofilla per del puro oro organico. Tragicamente poco longeva, quest'erba Ã¨ un vicolo cieco nell'evoluzione, ma almeno Ã¨ bella da vedere.",
	"Shimmerlily": "Giglio di luce",
	"[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.": "Questi piccoli fiori si trovano piÃ¹ facilmente all'alba, quando i raggi del sole si rifrangono sulle gocce di rugiada e attraggono l'attenzione sui loro candidi petali.",
	...
	"[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.": "Una varietÃ  chiara e ancora piÃ¹ dolce della cioccoradice. Spesso ostacola i viandanti con i suoi rami contorti.",
	...
	"[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.": "Tradizionalmente utilizzata per preparare un tÃ¨ rilassante, che assicura una buona notte di riposo.",
	"Wardlichen": "Lichene custode",
	"[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.": "Ãˆ risaputo che il fetore metallico emanato da questo organismo tiene a distanza insetti e lumache.",
	"Keenmoss": "Muschio sagace",
	"[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.": "Soffice al tatto e di un intenso colore verde. Nella simbologia botanica, il muschio sagace Ã¨ un augurio di buona fortuna per ritrovare oggetti perduti.",
	"Queenbeet": "Bietola regia",
	"[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.": "Gustoso fittone utilizzato per preparare zucchero bianco di alta qualitÃ . Un tempo fu causa di guerre tra intere nazioni.",
	"Juicy queenbeet": "Bietola regia succulenta",
	"[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.": "Gustoso fittone utilizzato per preparare zucchero bianco di alta qualitÃ . Un tempo fu causa di guerre tra intere nazioni.<br>Sembra che crescere a stretto contatto con altre bietole regie abbia reso questo esemplare particolarmente dolce e succoso.",
	"Duketater": "Patata ducale",
	"[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.": "Raro tubero dal gusto ricco. Ãˆ tanto nutriente da bastare per un intero pasto, purchÃ© si rispetti il rigido calendario di raccolta. Il suo amido presenta interessanti proprietÃ  per la pasticceria.",
	...
	"[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.": "Piccolo, tenace e ottimo nelle frittate. Alcuni storici suggeriscono che le cappelle secche dei tirchiodini fossero utilizzate come valuta in alcune comunitÃ  dell'etÃ  del bronzo.",
	"Fool's bolete": "Porcino impostore",
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.": "Il nome rimanda alla sua capacitÃ  di ingannare i raccoglitori di funghi. Il porcino impostore non Ã¨ velenoso, ha semplicemente un sapore insulso.",
	...
	"[Green rot quote]This short-lived mold is also known as \"emerald pebbles\", and is considered by some as a pseudo-gem that symbolizes good fortune.": "Questa muffa dalla vita breve Ã¨ anche conosciuta come \"ciottoli di smeraldo\" e viene considerata una pseudo-gemma, simbolo di buona ventura.",
	...
	"[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.": "Alcuni la ritengono un super alimento a causa della longevitÃ  e dell'affascinante geometria che la contraddistinguono, ma in realtÃ  questo misterioso fiore Ã¨ leggermente tossico.",
	"Ichorpuff": "Vescia icorica",
	"[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.": "Questa vescia contiene spore di zucchero, ma non sembra mai raggiungere la maturitÃ  necessaria a rilasciarle. Influisce sulle piante circostanti rallentandone il metabolismo, riducendone gli effetti ma allungandone il ciclo vitale.",
	"Garden information": "Informazioni sul giardino",
	"Your garden is frozen, providing no effects.": "Il tuo giardino Ã¨ congelato e non produce alcun effetto.",
	"Combined effects of all your plants:": "Effetto combinato di tutte le tue piante:",
	"None.": "nessuno.",
	"-You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles next to them.<br>-Unlock new seeds by harvesting mature plants.<br>-When you ascend, your garden plants are reset, but you keep all the seeds you've unlocked.<br>-Your garden has no effect and does not grow while the game is closed.": "-Puoi incrociare le piante piantandone una accanto all'altra: le nuove piante cresceranno nei riquadri vuoti lÃ¬ accanto.<br>-Sblocca nuovi semi raccogliendo piante mature.<br>-Risalendo, le piante del tuo giardino vengono azzerate, ma conservi tutti i semi che hai sbloccato.<br>-Quando il gioco Ã¨ chiuso, il tuo giardino non produce effetti e le piante non crescono.",
	...
	"Freeze": "Congela",
	"Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class=\"line\"></div>Using this will effectively pause your garden.": "Conserva criogenicamente il tuo giardino.<br>Le piante non crescono, non si diffondono e non muoiono piÃ¹: non producono piÃ¹ alcun effetto.<br>Il terreno non puÃ² essere cambiato.<div class=\"line\"></div>L'uso di questa funzione metterÃ  come in pausa il tuo giardino.",
	"Garden is frozen. Unfreeze to resume.": "Il giardino Ã¨ congelato. Scongelalo per riprendere.",
	"Sacrifice garden": "Sacrifica il giardino",
	"A swarm of sugar hornets comes down on your garden, <span class=\"red\">destroying every plant as well as every seed you've unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class=\"green\">%2</span>.<br>This action is only available with a complete seed log.": "Uno sciame di calabroni zuccherini si Ã¨ abbattuto sul tuo giardino <span class=\"red\">distruggendo tutte le piante e tutti i semi che hai sbloccato.</span>Ti hanno lasciato solo un seme di %1.<br>In cambio, ti conferiranno <span class=\"green\">%2</span>.<br>Questa azione Ã¨ disponibile solo con un registro dei semi al completo.",
	"Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>": "Vuoi DAVVERO sacrificare il tuo giardino e lasciarlo in balÃ¬a dei calabroni zuccherini?<br><small>Rimarrai con un appezzamento vuoto e con il solo seme di %1 sbloccato.<br>In cambio otterrai <b>%2 zollette di zucchero</b>.</small>",
	...
	"surrounding plants (%1x%1) age %2% faster": "le piante circostanti (%1x%1) invecchiano il %2% piÃ¹ velocemente",
	"surrounding plants (%1x%1) age %2% slower": "le piante circostanti (%1x%1) invecchiano il %2% piÃ¹ lentamente",
	"surrounding plants (%1x%1) are %2% more efficient": "le piante circostanti (%1x%1) sono il %2% piÃ¹ efficienti",
	...
	"may spread as %1": "puÃ² diffondersi come %1",
	"grows in empty tiles": "cresce in riquadri vuoti",
	"may overtake nearby plants": "puÃ² invadere le piante vicine",
	"may sometimes drop spores when uprooted": "a volte puÃ² far cadere spore se sradicata",
	...
	"cannot handle cold climates; %1% chance to die when frozen": "non sopporta i climi freddi: ha una probabilitÃ  del %1% di morire quando congelata",
	...
	"Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.": "Terreno con una sana dose di concime fresco. Le piante crescono piÃ¹ velocemente ma sono meno efficienti.",
	"Clay": "Argilla",
	"Rich soil with very good water retention. Plants grow slower but are more efficient.": "Terreno ricco con un'ottima ritenzione idrica. Le piante crescono piÃ¹ lentamente ma sono piÃ¹ efficienti.",
	"Pebbles": "Ciottoli",
	...
	"<b>%1% chance</b> of collecting seeds automatically when plants expire": "<b>probabilitÃ  del %1%</b> di raccogliere semi automaticamente quando la pianta appassisce",
	"plants spread and mutate <b>%1 times more</b>": "le piante si diffondono e mutano <b>%1 volte di piÃ¹</b>",
	...
	"This seed cannot be planted.": "Questo seme non puÃ² essere piantato.",
	"Empty tile": "Riquadro vuoto",
	"This tile of soil is empty.<br>Pick a seed and plant something!": "Questo riquadro di terreno Ã¨ vuoto.<br>Scegli un seme e piantalo!",
	"Click to plant %1 for %2.": "Fai clic per piantare %1 per %2.",
	"%1 to plant multiple.": "%1 per piantarne di piÃ¹.",
	...
	"may reproduce, will drop seed when harvested": "puÃ² riprodursi, lascerÃ  cadere semi quando raccolta",
	"Click to harvest.": "Fai clic per raccogliere.",
	"Click to unearth.": "Fai clic per scavare.",
	"Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.": "Fai clic per ricaricare il timer del terreno e azionare <b>1</b> mossa della crescita delle piante con velocitÃ  di diffusione <b>x%1</b> e velocitÃ  di mutazione del %2.",
	...
	"Garden plants age and mutate %1% faster.": "La piante del giardino invecchiano e mutano il %1% piÃ¹ velocemente.",
	"while plant is alive; scales with plant growth": "mentre la pianta Ã¨ viva; si adatta alla crescita della pianta",
	"Dungeon": "Segrete",
	"Grimoire": "Grimorio",
	"This is your magic meter. Each spell costs magic to use.<div class=\"line\"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class=\"line\"></div>Magic refills over time. The lower your magic meter, the slower it refills.": "Questo Ã¨ il tuo rilevatore di magia. Lanciare un incantesimo ti costerÃ  della magia.<div class=\"line\"></div>Il tuo quantitativo massimo di magia varia a seconda del numero di <b>Torri stregate</b> e al loro livello.<div class=\"line\"></div>La magia si ricarica con trascorrere del tempo. PiÃ¹ basso Ã¨ il valore dato dal tuo rilevatore di magia e piÃ¹ tempo impiegherÃ  per ricaricarsi.",
	"Spells cast: %1 (total: %2)": "Lancio di incantesimi: %1 (totale: %2)",
	"Magic cost:": "Costo magia:",
	"Chance to backfire:": "ProbabilitÃ  di ritorsione:",
	"Effect:": "Effetto:",
	"Backfire:": "Ritorsione:",
	"Backfire!": "Ritorsione!",
	"%1 magic": "%1 magia",
	"+%1% of max magic": "+%1% di magia max.",
	"Click to refill <b>%1 units</b> of your magic meter for %2.": "Fai clic per ricaricare <b>%1 unitÃ </b> del tuo rilevatore di magia per %2.",
	"Grimoire spells are %1% cheaper but fail %1% more.": "Gli incantesimi del Grimorio sono meno cari del %1% ma falliscono il %1% di piÃ¹.",
	...
	"Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.": "Evoca un biscotto dorato a caso. Ciascun biscotto dorato esistente aumenta del %1% le probabilitÃ  che questo incantesimo si ritorca contro di te.",
	...
	"All active buffs gain %1% more time (up to %2 more minutes).": "Tutti i bonus attivi vedono prolungato del %1% il loro tempo (fino a %2 minuti in piÃ¹).",
	...
	"Upgrades are %1% more expensive for an hour.": "I potenziamenti sono piÃ¹ cari del %1% per un'ora.",
	"Upgrades are cheaper!": "I potenziamenti sono meno cari!",
	"Upgrades are pricier!": "I potenziamenti sono piÃ¹ cari!",
	...
	"Buildings are %1% more expensive for an hour.": "Le strutture sono piÃ¹ care del %1% per un'ora.",
	"Buildings are cheaper!": "Le strutture sono meno care!",
	"Buildings are pricier!": "Le strutture sono piÃ¹ care!",
	"Gambler's Fever Dream": "Sogno delirante del giocatore d'azzardo",
	"Cast a random spell at half the magic cost, with twice the chance of backfiring.": "Lancia un incantesimo a meta prezzo in magia, con il doppio delle probabilitÃ  che si ritorca contro di te.",
	"No eligible spells!": "Nessun incantesimo idoneo!",
	"That's too bad!<br>Magic refunded.": "Ãˆ un vero peccato!<br>Magia rimborsata.",
	...
	"But no wrinkler was harmed.": "Ma nessun divoratore Ã¨ stato maltrattato.",
	...
	"Spells backfire %1 times more for the next %2 minutes.": "Gli incantesimi ti si ritorcono contro %1 volte di piÃ¹ per i prossimi %2 minuti.",
	...
	"[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.": "Una vita immortale trascorsa a concentrarsi sul proprio sÃ© interiore, lontano dalle cose materiali.",
	...
	"[GOD 5 NAME]Selebrak, Spirit of Festivities": "Selebrak, spirito delle festivitÃ ",
	"[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.": "Questo Ã¨ lo spirito delle scappatelle piÃ¹ scanzonate e dei rimpianti che ne seguono.",
	"[GOD 6 NAME]Dotjeiess, Spirit of Creation": "Dotjeiess, spirito della creazione",
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.": "Tutto ciÃ² che Ã¨ stato e che sarÃ  Ã¨ stato giÃ  scritto tempo fa dagli imperscrutabili viticci di questo spirito.",
	...
	"[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.": "Sebbene questo spirito abbia molti rimpianti, aiutarti a dominare il mondo attraverso la costante industrializzazione non Ã¨ uno di questi.",
	"[GOD 9 NAME]Mokalsium, Mother Spirit": "Mokalsium, spirito madre",
	"[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.": "Uno spirito gentile che si dice contenga se stesso, dentro di sÃ© infinitamente.",
	...
	"[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.": "Scoprirai che la vita diventa un po' piÃ¹ dolce se riesci a motivare questo spirito con numeri ordinati e dichiarazioni dei redditi adeguatamente compilate.",
	...
	"If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.": "Se fai clic su un biscotto dorato, questo spirito verrÃ  rimosso dallo slot e tutti gli scambi devozionali verranno consumati.",
	"Each time you slot a spirit, you use up one worship swap.<div class=\"line\"></div>If you have 2 swaps left, the next one will refill after %1.<br>If you have 1 swap left, the next one will refill after %2.<br>If you have 0 swaps left, you will get one after %3.<div class=\"line\"></div>Unslotting a spirit costs no swaps.": "Ogni volta che inserisci uno spirito in uno slot consumi uno scambio devozionale.<div class=\"line\"></div>Se ti rimangono 2 scambi, il prossimo si rigenererÃ  dopo %1.<br>Se ti rimane 1 scambio, il prossimo si rigenererÃ  dopo %2.<br>Se sei rimasto a 0 scambi, ne otterrai uno dopo %3.<div class=\"line\"></div>Rimuovere uno spirito da uno slot non consuma scambi.",
	...
	"[STOCK 13 NAME]Prosperity Hive": "Alveare della prosperitÃ ",
	...
	"from %1": "da %1",
	"%1: currently worth <b>$%2</b> per unit.": "%1: attualmente vale <b>$%2</b> per unitÃ .",
	"You currently own %1 (worth <b>$%2</b>).": "Attualmente possiedi %1 (valore: <b>$%2</b>).",
	"Your warehouses can store up to %1.": "Il tuo magazzino puÃ² ospitare fino a %1.",
	...
	"The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.": "Il valore medio di questo titolo azionario e il picco che puÃ² raggiungere dipende dalla struttura a cui Ã¨ legato, insieme al livello del tuo %1.",
	...
	"This is your office.": "Questo Ã¨ il tuo ufficio.",
	"It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.": "Ãˆ stato totalmente potenziato. I suoi sontuosi interni, che si estendono su innumerevoli piani, ospitano molte feste faraoniche grazie alla tua quasi incalcolabile ricchezza.",
	...
	"Palace of Greed": "Palazzo dell'aviditÃ ",
	"Upgrading will cost you %1.": "Il potenziamento ti costerÃ  %1.",
	"Upgrading requires %1.": "Il potenziamento richiede %1.",
	"Upgrading will grant you:": "Il potenziamento ti conferirÃ :",
	"+1 loan slot": "+1 slot prestito",
	"+1 opportunity slot": "+1 slot opportunitÃ ",
	...
	"Brokers:": "Broker:",
	"A nice broker to trade more cookies.": "Un abile broker per lo scambio di piÃ¹ biscotti.",
	"Hire": "Assumi",
	...
	"Buying a broker costs %1 of CpS (that's $%2).": "Il prezzo per l'acquisto di un broker Ã¨ di %1 di BpS, cioÃ¨ $%2.",
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)": "Numero massimo di broker che puoi possedere: %1 (la quantitÃ  piÃ¹ elevata di nonnine in tuo possesso per questa serie, divisa per 10, piÃ¹ il tuo livello nonnina)",
	...
	"Hiring a new broker will cost you %1.": "Assumere un nuovo broker ti costerÃ  %1.",
	"Take out %1": "Chiedi in prestito %1",
	"Loan #%1": "Presta #%1",
	"a modest loan": "un prestito modesto",
	"Buy that vintage car you've always wanted. Just pay us back.": "Acquista quell'auto d'epoca che hai sempre desiderato. L'importante Ã¨ ripagarci.",
	...
	"However, you will get %1 CpS for the next %2 after that.": "Tuttavia, dopo di ciÃ² otterrai %1 BpS per i prossimi %2.",
	"You must also pay an immediate downpayment of %1 (<b>%2%</b> of your current bank).": "Inoltre Ã¨ necessario pagare un acconto immediato di %1 (<b>%2%</b> della tua banca attuale).",
	"Loan over": "Prestito terminato",
	"Your loan has expired, and you must now repay the interest.": "Il tuo prestito Ã¨ scaduto e ora devi pagare gli interessi.",
	"Line style": "Stile linea",
	"Color mode": "ModalitÃ  colore",
	"Toggle speed": "Attiva/disattiva velocitÃ ",
	"Click to refill your opportunity timer (and give a quick burst to your economy) for %1.": "Fai clic per ricaricare il tuo timer delle opportunitÃ  (e dai una scossa di energia alle tue finanze) al prezzo di %1.",
	...
	"The stock market is more chaotic.": "Il mercato azionario Ã¨ piÃ¹ caotico.",
	...
	"[Upgrade name 13]Sturdier conveyor belts": "Nastri trasportatori piÃ¹ robusti",
	...
	"[Upgrade name 51]Causality enforcer": "Esecutore di causalitÃ ",
	"[Upgrade name 52]Lucky day": "Giorno fortunato",
	"[Upgrade name 53]Serendipity": "SerendipitÃ ",
	...
	"[Upgrade name 93]British tea biscuits": "Biscotti da tÃ¨",
	"[Upgrade name 94]Chocolate british tea biscuits": "Biscotti da tÃ¨ al cioccolato",
	"[Upgrade name 95]Round british tea biscuits": "Biscotti da tÃ¨ rotondi",
	"[Upgrade name 96]Round chocolate british tea biscuits": "Biscotti da tÃ¨ rotondi al cioccolato",
	"[Upgrade name 97]Round british tea biscuits with heart motif": "Biscotti da tÃ¨ rotondi con cuore",
	"[Upgrade name 98]Round chocolate british tea biscuits with heart motif": "Biscotti da tÃ¨ rotondi al cioccolato con cuore",
	...
	"[Upgrade name 107]Sabl&eacute;s": "SablÃ©",
	...
	"[Upgrade name 124]Perfect idling": "PassivitÃ  totale",
	...
	"[Upgrade name 165]Santa's legacy": "EreditÃ  di Babbo Natale",
	...
	"[Upgrade name 223]Faberge egg": "Uovo fabergÃ©",
	...
	"[Upgrade name 241]Sun festival": "FestivitÃ  del sole",
	...
	"[Upgrade name 244]Pointier hats": "Cappelli piÃ¹ a punta",
	"[Upgrade name 245]Beardlier beards": "Barbe piÃ¹ folte",
	...
	"[Upgrade name 253]Tin of british tea biscuits": "Latta di biscotti da tÃ¨",
	...
	"[Upgrade name 276]Virtues": "VirtÃ¹",
	...
	"[Upgrade name 302]Theory of atomic fluidity": "Teoria della fluiditÃ  atomica",
	...
	"[Upgrade name 358]Beelzebub": "BelzebÃ¹",
	...
	"[Upgrade name 375]Contracts from beyond": "Contratti dall'aldilÃ ",
	...
	"[Upgrade name 422]Improbability drive": "Motore dell'improbabilitÃ ",
	...
	"[Upgrade name 474]Fern tea": "TÃ¨ alla felce",
	...
	"[Upgrade name 511]War of the gods": "Guerra degli dÃ¨i",
	"[Upgrade name 512]Electricity": "ElettricitÃ ",
	...
	"[Upgrade name 561]Genius accounting": "Genio della contabilitÃ ",
	...
	"[Upgrade name 567]Chocolate chip mocha cookies": "Biscotti al caffÃ¨ con scaglie di cioccolato",
	...
	"[Upgrade name 599]A nice cup of coffee": "Una bella tazza di caffÃ¨",
	...
	"[Upgrade name 614]Chai tea cookies": "Biscotti al tÃ¨ chai",
	...
	"[Upgrade name 674]Light speed limit": "Limite di velocitÃ  della luce",
	...
	"[Upgrade name 693]Encapsulated realities": "RealtÃ  incapsulate",
	"[Upgrade name 694]Extrinsic clicking": "Clic estrinsechi",
	"[Upgrade name 695]Universal idling": "PassivitÃ  universale",
	...
	"[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets": "Pastiglie NoLatteÂ® per il sollievo dell'intolleranza al lattosio",
	...
	"[Upgrade name 724]Matcha cookies": "Biscotti al tÃ¨ matcha",
	...
	"[Upgrade name 732]A sprinkle of irrationality": "Una spolverata di irrazionalitÃ ",
	...
	"[Achievement name 12]Don't stop me now": "Nessuno puÃ² fermarmi",
	...
	"[Achievement name 25]Let's never bake again": "Mai piÃ¹ infornate",
	...
	"[Achievement name 44]Reap what you sow": "Raccogli ciÃ² che semini",
	...
	"[Achievement name 58]A whole new world": "Il mondo Ã¨ mio",
	"[Achievement name 59]Now you're thinking": "Ora sÃ¬ che ragioniamo",
	...
	"[Achievement name 98]Chirped out": "Senza piÃ¹ brio",
	...
	"[Achievement name 109]Coming to town": "Arrivo in cittÃ ",
	...
	"[Achievement name 117]Can you dig it": "Scavando di qua e di lÃ ",
	...
	"[Achievement name 147]Extreme polydactyly": "PolidattilitÃ  estrema",
	"[Achievement name 148]Dr. T": "Dottor T",
	"[Achievement name 149]The old never bothered me anyway": "Da oggi il vecchio Ã¨ casa mia",
	...
	"[Achievement name 166]The hunt is on": "La caccia Ã¨ aperta",
	...
	"[Achievement name 170]What's in a name": "Che cos'Ã¨ un nome",
	...
	"[Achievement name 174]Need for greed": "A tutta aviditÃ ",
	"[Achievement name 175]It's the economy, stupid": "Ãˆ l'economia, idiota",
	...
	"[Achievement name 193]Yes I love technology": "SÃ¬, adoro la tecnologia",
	...
	"[Achievement name 197]The most precious cargo": "Il carico piÃ¹ prezioso",
	"[Achievement name 198]The Aureate": "L'aureato",
	"[Achievement name 199]Ever more hideous": "Ancora piÃ¹ orrendo",
	"[Achievement name 200]Be kind, rewind": "Senza pensieri, riportami a ieri",
	"[Achievement name 201]Infinitesimal": "Infinitesimale",
	"[Achievement name 202]A still more glorious dawn": "Un'alba ancora piÃ¹ gloriosa",
	...
	"[Achievement name 209]To oldly go": "Dove nessuno Ã¨ mai invecchiato prima",
	...
	"[Achievement name 213]Acquire currency": "Ottieni liquiditÃ ",
	...
	"[Achievement name 228]We're gonna need a bigger bakery": "Ci serve una pasticceria piÃ¹ grossa",
	...
	"[Achievement name 232]When this baby hits 36 quadrillion cookies per hour": "Quando questo aggeggio toccherÃ  i 36 biliardi di biscotti oraribiscotto",
	...
	"[Achievement name 240]There's really no hard limit to how long these achievement names can be and to be quite honest I'm rather curious to see how far we can go.<br>Adolphus W. Green (1844â€“1917) started as the Principal of the Groton School in 1864. By 1865, he became second assistant librarian at the New York Mercantile Library; from 1867 to 1869, he was promoted to full librarian. From 1869 to 1873, he worked for Evarts, Southmayd & Choate, a law firm co-founded by William M. Evarts, Charles Ferdinand Southmayd and Joseph Hodges Choate. He was admitted to the New York State Bar Association in 1873.<br>Anyway, how's your day been?": "Non c'Ã¨ alcun limite massimo di caratteri per il nome di questi obiettivi e, in tutta onestÃ , sono proprio curioso di sapere fino a che punto possiamo arrivare.<br>Adolphus W. Green (1844â€“1917) iniziÃ² la sua carriera nel 1864 come preside della Groton School. Nel 1865 divenne secondo assistente bibliotecario presso la Biblioteca mercantile di New York; dal 1867 al 1869 fu promosso bibliotecario a pieno titolo. Dal 1869 al 1873 lavorÃ² per Evarts, Southmayd &amp; Choate, uno studio legale co-fondato da William M. Evarts, Charles Ferdinand Southmayd e Joseph Hodges Choate. Nel 1873 fu ammesso all'Ordine degli avvocati dello stato di New York.<br>Cambiando discorso, come sta andando la tua giornata?",
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience": "Per il mio prossimo trucco, avrÃ² bisogno di un volontario dal pubblico",
	...
	"[Achievement name 270]Sugar sugar": "Zucchero e piÃ¹ zucchero",
	...
	"[Achievement name 278]If it's worth doing, it's worth overdoing": "CiÃ² che vale la pena di fare, vale la pena di esagerare",
	"[Achievement name 279]The dreams in which I'm baking are the best I've ever had": "E naufragar m'Ã¨ dolce in questo impasto",
	...
	"[Achievement name 287]Make it so": "Facciamo cosÃ¬",
	"[Achievement name 288]All that glitters is gold": "Ãˆ tutto oro quel che luccica",
	...
	"[Achievement name 294]Frantiquities": "AntichitÃ  sfrenate",
	...
	"[Achievement name 303]Which eternal lie": "CiÃ² che puÃ² vivere in eterno",
	...
	"[Achievement name 310]D-d-d-d-deeper": "Sempre piÃ¹ giÃ¹",
	...
	"[Achievement name 326]What are the odds": "Che probabilitÃ  ci sono",
	"[Achievement name 327]Grandma needs a new pair of shoes": "A nonna serve un bel paio di scarpe nuove",
	"[Achievement name 328]Million to one shot, doc": "Una probabilitÃ  su un milione",
	...
	"[Achievement name 339]101st birthday": "101Â° compleanno",
	...
	"[Achievement name 347]That's just peanuts to space": "Ãˆ una briciola in confronto allo spazio",
	"[Achievement name 348]Worth its weight in lead": "Vale il suo peso in piombo",
	"[Achievement name 349]What happens in the vortex stays in the vortex": "CiÃ² che accade nel vortice resta nel vortice",
	...
	"[Achievement name 353]Maybe a chance in hell, actually": "Nessuna minima possibilitÃ ",
	...
	"[Achievement name 357]Save your breath because that's all you've got left": "Risparmia il fiato, Ã¨ tutto ciÃ² che ti resta",
	...
	"[Achievement name 362]Objects in the mirror dimension are closer than they appear": "Gli oggetti nelle dimensioni specchio sono piÃ¹ vicini di quanto appaiano",
	...
	"[Achievement name 367]So much to do so much to see": "CosÃ¬ tanto da fare, cosÃ¬ tanto da vedere",
	...
	"[Achievement name 374]Just about full": "Quasi a sazietÃ ",
	...
	"[Achievement name 380]In the garden of Eden (baby)": "Nel giardino dell'Eden (cara, ogni giorno ti amo di piÃ¹)",
	...
	"[Achievement name 398]With her finger and her thumb": "Oh, accidenti, le dita non me le sento piÃ¹... io le dita non ce le ho!",
	...
	"[Achievement name 402]Break the mold": "La perfetta cittÃ , qualche regola c'Ã¨, certo servirÃ ",
	"[Achievement name 403]Get the show on, get paid": "Vai, vai, vai, il piÃ¹ veloce che sai",
	"[Achievement name 404]My world's on fire, how about yours": "Oh, santo piripillo!",
	"[Achievement name 405]The meteor men beg to differ": "Il mago sarÃ  in cima alle scale, nella stanza piÃ¹ remota della torre piÃ¹ alta",
	"[Achievement name 406]Only shooting stars": "Allora, ci sono dei ciuchini lassÃ¹?",
	...
	"[Achievement name 410]What a concept": "A volte le cose sono molto di piÃ¹ di quello che appaiono",
	...
	"[Achievement name 426]We must go deeper": "Dobbiamo andare piÃ¹ a fondo",
	"[Achievement name 427]Sierpinski rhomboids": "Romboidi di SierpiÅ„ski",
	"[Achievement name 428]Gotta go fast": "Sento il bisogno... il bisogno di velocitÃ !",
	...
	"[Achievement name 449]You're #1 so why try harder": "Sei giÃ  il migliore, perchÃ© faticare ancora",
	"[Achievement name 450]Haven't even begun to peak": "La vetta Ã¨ ancora lontana",
	"[Achievement name 451]A sometimes food": "In moderate quantitÃ ",
	"[Achievement name 452]Not enough of a good thing": "La bontÃ  non basta mai",
	...
	"[Achievement name 459]No nobility in poverty": "Non c'Ã¨ nobiltÃ  nella povertÃ ",
	...
	"[Achievement name 472]It's only wafer-thin": "Ãˆ solo una sfoglia sottilissima",
	...
	"[Achievement name 478]Self-manmade man": "Uomo fatto da sÃ©",
	...
	"[Achievement name 500]Is there life on Mars?": "C'Ã¨ vita su Marte?",
	"[Achievement name 501]Bad chemistry": "Non c'Ã¨ chimica",
	"[Achievement name 502]Reduced to gibbering heaps": "Ridotto a un ammasso farfugliante",
	"[Achievement name 503]Back already?": "GiÃ  di ritorno?",
	...
	"[Achievement name 507]In and of itself": "In sÃ© e per sÃ©",
	...
	"[Achievement name 521]Reject reality, substitute your own": "Rifiuta la realtÃ , imponi la tua",
	...
	"[Achievement name 529]When there's nothing left to add": "Non c'Ã¨ nulla da aggiungere",
	"[Achievement name 530]Sexcentennial": "Seicentenario",
	"[Achievement name 531]Keep going until I say stop": "Continua finchÃ© non ti dico di fermarti",
	...
	"[Achievement name 536]Max capacity": "CapacitÃ  massima",
	"[Achievement name 537]Liquid assets": "Patrimonio liquido",
	"[Achievement name 538]Stifling the press": "Soffocare la stampa",
	"[Achievement name 539]It's big brain time": "Ãˆ il momento dei cervelloni",
	"[Achievement name 540]Just my imagination": "Solo la mia immaginazione",
	"[Achievement name 541]Now there's an idea": "Questa sÃ¬ che Ã¨ un'idea",
	"[Achievement name 542]The organ that named itself": "L'organo che si Ã¨ dato un nome da solo",
	...
	"[Achievement name 557]It's grown on you": "Ti piacerÃ ",
	...
	"[Achievement name 569]Never tell me the odds": "Non mi importa delle probabilitÃ ",
	...
	"[Achievement name 573]By will alone I set my mind in motion": "Ãˆ con la sola volontÃ  che metto in moto il mio pensiero",
	...
	"[Achievement name 576]I am speed": "Io sono la velocitÃ ",
	...
	"[Achievement name 580]Baby it's old outside": "Roba vecchia lÃ  fuori",
	"[Achievement name 581]Myriad": "Myriad",
	"[Achievement name 582]Kaizen": "Kaizen",
	"[Achievement name 583]Beyond quality": "Oltre la qualitÃ ",
	"[Achievement name 584]Everything happens so much": "Tutto e troppo",
	"[Achievement name 585]I'll rest when I'm dead": "RiposerÃ² quando sarÃ² morto",
