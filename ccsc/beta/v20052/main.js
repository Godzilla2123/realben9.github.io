...
Game.Launch=function()
{
	...
	'<div class="listing">We have an <a href="http://forum.dashnet.org" target="_blank">official forum</a>; '+
		...
		'or the <a href="http://cookieclicker.wikia.com/wiki/Cookie_Clicker_Wiki" target="_blank">wiki</a>. We\'re also on <a href="https://discordapp.com/invite/r6hssr5" target="_blank">Discord</a>.</div>'+
	...
	Game.Init=function()
	{
		...
		Game.computeLumpTimes=function()
		{
			...
			if (Game.Has('Sugar aging process')) Game.lumpRipeAge-=6000*Math.min(500,Game.Objects['Grandma'].amount);//capped at 500 grandmas
		...
		new Game.Upgrade('Sugar aging process','Each grandma makes sugar lumps ripen <b>6 seconds</b> sooner.<q>Aren\'t they just the sweetest?</q>',600000000,[23,17]);Game.last.pool='prestige';Game.last.parents=['Sugar craving','Diabetica Daemonicus'];
		...
		order=40000;
		new Game.Upgrade('Turbo-charged soil','Garden plants grow every second.<q>It\'s got electrolytes!</q>',7,[2,16]);//debug purposes only
